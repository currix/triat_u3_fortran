...
C     
      ...
      IF (L.EQ.0.AND.IOPTS.NE.1) EMIN = EIGEN(1)
C     
      WRITE(*,*)
C      WRITE(*,10) N2, L, DIM
      DO I = 1, DIM
         ...
         SO3VAL = 0.0
         DO J = 1, DIM
            U2VAL = U2VAL + HAM(J,I)**4
            SO3VAL = SO3VAL + AVECSO3(J,I)**4
         ENDDO
         WRITE(*,15) EIGEN(I) - EMIN, 1.0D0/U2VAL, 1.0D0/SO3VAL
      ENDDO
C     
C 10   FORMAT(1X,"N = ",I5,1X,", l = ", I3, 1X,", DIM = ", I6)
 15   FORMAT(4X,G20.8,2X,G22.12,2x,G22.12)
C     
